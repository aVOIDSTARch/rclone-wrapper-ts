// This is the dump from rclone --help
...
Flags for general configuration of rclone (flag group Config):
      ...
      --cache-dir string                    Directory rclone will use for caching (default "/Users/louisc/Library/Caches/rclone")
      --color AUTO|NEVER|ALWAYS             When to show colors (and other ANSI codes) AUTO|NEVER|ALWAYS (default AUTO)
      --config string                       Config file (default "/Users/louisc/.config/rclone/rclone.conf")
  ...
  -i, --interactive                         Enable interactive mode
      ...
      --temp-dir string                     Directory rclone will use for temporary files (default "/var/folders/8v/d221ltms4915g_r6kxflzyk80000gn/T/")
...
Backend-only flags (these can be set in the config file also) (flag group Backend):
      ...
      --cache-chunk-path string                             Directory to cache chunk files (default "/Users/louisc/Library/Caches/rclone/cache-backend")
      ...
      --cache-db-path string                                Directory to store file structure metadata DB (default "/Users/louisc/Library/Caches/rclone/cache-backend")
  ...
  -L, --copy-links                                          Follow symlinks and copy the pointed to item
      ...
      --ftp-user string                                     FTP username (default "louisc")
  ...
  -x, --one-file-system                                     Don't cross filesystem boundaries (unix/macOS only)
      ...
      --sftp-user string                                    SSH username (default "louisc")
      ...
      --smb-user string                                     SMB username (default "louisc")
